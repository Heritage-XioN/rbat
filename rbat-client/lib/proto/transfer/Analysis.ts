...
export interface AnalysisClient extends grpc.Client {
  UploadBinary(
    ...
    callback: grpc.requestCallback<_transfer_UploadResponse__Output>,
  ): grpc.ClientWritableStream<_transfer_UploadRequest>;
  UploadBinary(
    metadata: grpc.Metadata,
    callback: grpc.requestCallback<_transfer_UploadResponse__Output>,
  ): grpc.ClientWritableStream<_transfer_UploadRequest>;
...
export interface AnalysisHandlers extends grpc.UntypedServiceImplementation {
  UploadBinary: grpc.handleClientStreamingCall<
